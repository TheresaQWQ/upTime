...

{
            ...
            $bcc = "", $additional_headers = "")
    {
        ...
        $header .= "From: " . '=?utf-8?B?' . base64_encode('IMoe站点监控') . '?=' .
                "<" . $from . ">\r\n";
        
        $header .= "Subject: " . '=?utf-8?B?' . base64_encode(
                '' . $subject . '') . '?=' . "\r\n";
        ...
        $header .= "X-Mailer:By SendMail Module PHP (PHP/" . phpversion() .
                ")\r\n";
    ...
    {
        $this->log_write(
                "Trying to " . $this->relay_host . ":" . $this->smtp_port . "\n");
        ...
        if (! ($this->sock && $this->smtp_ok())) {
            ...
            $this->log_write(
                    "Error: Cannot connenct to relay host " . $this->relay_host .
                    "\n");
    ...
    function smtp_ok ()
    {
        ...
        if (! ereg("^[23]", $response)) {
            ...
            $this->log_write(
                    "Error: Remote host returned\"" . $response . "\"\n");
