    ...
    <body>
        ...
        <div class="page mdui-shadow-2">
            ...
            <div class="text">
                ...
                <h4><a href="./index.php" class="mdui-valign"><i class="mdui-icon material-icons">&#xe5c4;</i>返回</a></h4>
                <div class="mdui-tab mdui-tab-full-width" mdui-tab>
                    <a href="#tab1" class="mdui-ripple">折线图</a>
                    ...
                    <div class="mdui-table-fluid">
                        <table class="mdui-table mdui-table-hoverable">
                            ...
                            <tbody>
                                ...
                                }else if($row["netTime"] < 1200 && $row["netTime"] != -1){
                                    $netTime = '<td style="color: yellow">'.$row["netTime"]." ms";
                                }else{
                                    $netTime = '<td style="color: red">'.$row["netTime"]." ms";
                                }
